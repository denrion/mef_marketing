...
//
//@Tag(name = "MeetingResource",
//        description = "CRUD for scheduling meetings with potential students")
//@Path("meeting")
...
//                .entity(addHypermediaLinks(meetingSaved))
//                .build();
//    }
//
//    @PUT
...
//
//        return Response
//                .ok(addHypermediaLinks(meetingUpdated))
//                .build();
//    }
//
//    @DELETE
...
//    }
//
//    private JsonObject addHypermediaLinks(Meeting meeting) {
