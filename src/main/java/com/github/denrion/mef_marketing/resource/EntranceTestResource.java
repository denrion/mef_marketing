...
//
//@Tag(name = "EntranceTestResource",
//        description = "CRUD for scheduling entrance tests for potential students")
//@Path("tests")
...
//                .entity(addHypermediaLinks(entranceTest))
//                .build();
//
//    }
//
...
//
//        return Response
//                .ok(addHypermediaLinks(entranceTest))
//                .build();
//    }
//
//    @DELETE
...
//    }
//
//    private JsonObject addHypermediaLinks(EntranceTest test) {
