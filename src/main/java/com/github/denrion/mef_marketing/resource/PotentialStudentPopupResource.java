...
//
//@Tag(name = "PotentialStudentPopupResource", description = "CRUD for potential students who contacted by popup")
//@Path("popup")
...
//    }
//
//    private JsonObject addHypermediaLinks(PotentialStudentPopup psPopup) {
